...
const ThankYou = ({ data }: { data: Wedding }) => {
  return (
    <div className="flex flex-col items-center justify-center gap-4 px-5 pb-32 pt-24 text-center">
      ...
      <h3 className="castoro-regular mb-3 text-center text-xl font-semibold text-primary">
        THANK YOU FOR YOUR PRESENCE
      </h3>
      <p className="castoro-regular text-sm leading-8 text-body text-gray-500">{data.thanks_message}</p>

      <p className="pinyon-script-regular mt-8 text-4xl leading-8 text-gray-500 text-primary">
