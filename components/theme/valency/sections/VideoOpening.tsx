    ...
    <div className="relative flex h-full w-full items-center justify-center">
      ...
      <div className="absolute animate-fadeIn px-20 text-center opacity-0">
        ...
        <div className="flex flex-col gap-3">
          <h2 className="castoro-regular text-3xl font-semibold text-primary">{data.groom_nickname} Dharmawan</h2>
          <p className="pinyon-script-regular text-8xl font-semibold text-gray-500">&</p>
          <h2 className="castoro-regular text-3xl font-semibold text-primary">{data.bride_nickname}tun Hasanah</h2>
        </div>
